...
class InstrumentController:
    ...
    def createSculpture(self, id, name, price, materials):
        ...
        return self.strategy.create(Instrument(id, name, price, materials, finalPrice))
    ...
    def updateSculpture(self, id, name, price, materials):
        ...
        return self.strategy.update(id, Instrument(id, name, price, materials, newPriceWithIva))
