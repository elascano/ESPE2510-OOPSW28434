...
const ChickenCoopManagement = require('../ec.espe.edu.chickenFarmSimulator.model/ChickenCoopManagement');
...
allListCoops = [chickenCoop1, chickenCoop2, chickenCoop3];
...
(async() => {
    const csvfilname = "ChickenRegistration.csv";
    console.log(`\nIniciando Guardado de Datos ${csvfilname}`);
    await ChickenCoopManagement.saveChickenDataToCsv(allListCoops, csvfilname);
