...
from Chicken_coop_management import Chicken_coop_management
...
chickens_coops = [chicken_coop1, chicken_coop2, chicken_coop3]
...
Chicken_coop_management.save_chicken_to_csv(chickens_coops, "chicken_registration.csv")
