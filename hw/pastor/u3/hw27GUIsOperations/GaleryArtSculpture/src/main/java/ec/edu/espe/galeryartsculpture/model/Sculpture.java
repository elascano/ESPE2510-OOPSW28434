package ec.edu.espe.galeryartsculpture.model;
...
public class Sculpture {
    ...
    // --- [E] ENCAPSULATION: Atributos privados ---
    private String id;
    private String name;
    ...
    public Sculpture(String id, String name, double price, List<String> materials, double priceWithIva) {
        this.id = id;
        this.name = name;
        this.price = price;
