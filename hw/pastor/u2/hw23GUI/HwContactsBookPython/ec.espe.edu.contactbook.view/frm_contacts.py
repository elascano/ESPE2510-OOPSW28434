...
class FrmContacts(ctk.CTk):
    def __init__(self):
        ...
        self.button_group_sex = tk.StringVar()
    ...
    def _initComponents(self):
        ...
        self.jButton1 = ctk.CTkButton(self.jPanel2, text="SAVE", font=ctk.CTkFont(family="Footlight MT Light", size=16), fg_color="#000099")
