...
import ec.edu.espe.contactsbook.utils.MongoConnection;
...
public class FrmContacts extends javax.swing.JFrame {
 ...
 readValues();
    ...
    Document doc = new Document("firstName", contact.getFirstName())
    ...
    JOptionPane.showMessageDialog(this, "Contact saved in MongoDB!");
...
private void readValues() {
    ...
    int age = 0; // si quieres luego lo calculamos por fecha
    ...
    hobbies.addAll(lstHobbies.getSelectedValuesList()); // por si seleccionas varias

    String comments = txaComments.getText();

    contact = new Contact(age, firstName, lastName, birthDate, typeOfContact, sex, hobbies, comments);
}
