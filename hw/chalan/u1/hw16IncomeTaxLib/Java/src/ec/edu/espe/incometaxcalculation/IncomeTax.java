...
public class IncomeTax {
        ...
        while (true) {
            try {
                ...
                if (value < 0) {
                    ...
                    System.out.println("ERROR: Value cannot Be Cero.");
                } else if (value > 20000) {
                    System.out.printf("ERROR:  exceed $%.2f%n", 20000);
                } else {
                    return value;
                }
    ...
    public static int getValidatedSector(Scanner scanner) {
        while (true) {
            try {
                System.out.print("sector 1=Public, 2=Private: ");
                int sector = scanner.nextInt();
                if (sector == 1 || sector == 2) {
                    return sector;
                } else {
                    System.out.println("must be 1 (Public) O  2 (Private).");
                }
            } catch (Exception e) {
                System.out.println("nter 1 or 2.");
                scanner.nextLine();
            }
        }
    }
