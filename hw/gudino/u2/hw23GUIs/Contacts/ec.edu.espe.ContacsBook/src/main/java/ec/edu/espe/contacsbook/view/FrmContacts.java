...
// TODO add your handling code here:
    ...
    Object oldSelection = cmbDay.getSelectedItem();
    ...
    if (cmbDay.getItemCount() > 0) {
        // Intenta seleccionar el día 1 por defecto (índice 0)
        cmbDay.setSelectedIndex(0); 
        
        // OPCIONAL: Si quieres mantener la selección si es posible:
        
        if (oldSelection != null && cmbDay.getItemCount() >= Integer.parseInt(oldSelection.toString())) {
            cmbDay.setSelectedItem(oldSelection);
        } else {
            cmbDay.setSelectedIndex(0); 
        }
...
//    } catch (Exception e) {
//        lblAge.setText("..");  // Si falta algún dato
//    }
//}
