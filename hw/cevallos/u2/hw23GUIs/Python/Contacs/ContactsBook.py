...
ttk.Entry(left).grid(row=1, column=1, pady=5)

ttk.Label(left, text="Last Name:").grid(row=2, column=0, sticky="w", pady=5)
ttk.Entry(left).grid(row=2, column=1, pady=5)
...
DateEntry(left, width=17, background="darkblue", foreground="white", borderwidth=2).grid(row=4, column=1, pady=5)

ttk.Label(left, text="Type:").grid(row=5, column=0, sticky="w", pady=5)
ttk.Combobox(left, values=["Family", "Friend", "Work", "Other"]).grid(row=5, column=1, pady=5)
...
ttk.Entry(other_frame, width=15).pack(side="left", padx=5)
