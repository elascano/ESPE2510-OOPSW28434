...
class JSONFileManager {
    ...
    static loadFromFile() {
        try {
            if (!fs.existsSync(this.FILE_NAME)) {
                console.log("ℹ️ No existing data file found. Starting with empty farm.");
                return [];
            }
            ...
            if (coopData.chickens && Array.isArray(coopData.chickens)) {
                coopData.chickens.forEach(chickenData => {
                    try {
                        ...
                        console.log(`⚠️ Error creating chicken: ${error.message}`);
                    }
                });
            }
    ...
    static displayFileData() {
        try {
            if (!fs.existsSync(this.FILE_NAME)) {
                console.log("ℹ️ No data file found. Please save data first.");
                return;
            }
    ...
    static deleteFile() {
        try {
            if (fs.existsSync(this.FILE_NAME)) {
                ...
                console.log(`🗑️ File ${this.FILE_NAME} deleted successfully.`);
            } else {
                console.log(`ℹ️ File ${this.FILE_NAME} does not exist.`);
            }
        } catch (e) {
