...
public class JSONFileManager {
    private static final String FILE_NAME = "chickenFarm.json";
    ...
    /**
     * Load all coops and chickens from JSON file
     */
    ...
    /**
     * Parse the coops array from JSON string
     */
    ...
    /**
     * Parse a single coop object from JSON string
     */
    ...
    /**
     * Parse chickens array from JSON string
     */
    ...
    /**
     * Parse a single chicken object from JSON string
     */
    private static void parseChickenObject(String chickenObject, ChickenCoop coop) {
        try {
            ...
            // Usar addChickenSilent para evitar mensajes durante la carga
    ...
    /**
     * Add chicken without printing messages (for loading from JSON)
     */
    ...
    /**
     * Find matching bracket for JSON parsing
     */
    ...
    /**
     * Display all data from JSON file
     */
    ...
    /**
     * Update chicken data in JSON file
     */
    public static void updateChickenData(ArrayList<ChickenCoop> coops, int chickenId, String newName, String newColor, int newAge, boolean newMoltingStatus) {
        try {
            ...
            // Buscar la gallina en todos los coops
            ...
            for (ChickenCoop coop : coops) {
                if (coop.getId() == coopId) {
                    ...
                    for (int i = 0; i < chickens.size(); i++) {
                        ...
                        if (chicken.getId() == chickenId) {
                            // Eliminar la gallina del coop en memoria
                            chickens.remove(i);
                            chickenFound = true;
                            break;
                        }
