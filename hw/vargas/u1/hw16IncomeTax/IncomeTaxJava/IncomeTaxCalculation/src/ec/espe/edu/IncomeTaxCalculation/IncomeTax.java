...
public class IncomeTax {
    public static double incomeTaxCalculation(float monthlySalary,double annualPersonalExpenses,int numberOfFamilyDeficits){
        double taxBase;
        double taxDue;
    ...
    public static float calculateTaxableBase(float monthlySalary){
        float annualIncome;
    ...
    public static double calculateTaxDue (float monthlySalary){
    ...
    public static double calculateFinalDiscount(double annualPersonalExpenses,int numberOfFamilyDeficits) {
    ...
    public static double getMaximumDiscount (int numberOfFamilyDeficits ) {
