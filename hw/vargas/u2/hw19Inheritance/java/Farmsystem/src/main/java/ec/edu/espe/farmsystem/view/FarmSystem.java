...
public class FarmSystem {
    public static void main(String[] args) {
        ...
        lastShearing = new Date(2025,5,1);
        breed= "Holstein";
        ...
        cage = new Cage(1,"Corral for cows", 2);
            ...
            farmAnimal = new Sheep(lastShearing, 3, breed, bornOn, gender, isAbleToReproduce, weight, cage);
            System.out.println("farmAnimal --> " + farmAnimal);
            
            farmAnimal = new Pig(4, breed, bornOn, gender, isAbleToReproduce, weight, cage);
            System.out.println("farmAnimal --> " + farmAnimal);
