...
class StudentForm(tk.Tk):
    ...
    def create_widgets(self):
        ...
        # ---------- CAMPOS DE ENTRADA ----------
        tk.Label(self, text="ID:").place(x=30, y=0)
        self.txt_id = tk.Entry(self)
        self.txt_id.place(x=120, y=0)
    ...
    def add_student(self):
        """
        Registra un estudiante en MongoDB usando un ID ingresado por el usuario
        """
        try:
            student_id = self.txt_id.get()
            ...
            # Delegar creación al controlador con ID ingresado
            self.controller.create_student(student_id, name, grade, tuition)
