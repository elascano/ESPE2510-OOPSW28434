...
public class CustomerController {
    ...
    public Customer createCustomer(String name, String apartmentNumber,
        ...
        return new Customer(id, name, apartmentNumber, email, phone);
    }
    ...
    public boolean addCustomer(String name, String apartmentNumber,
            String email, String phone) {
        try {
            Customer customer = createCustomer(name, apartmentNumber, email, phone);
    ...
    public boolean updateCustomer(int id, String name, String apartmentNumber,
            String email, String phone) {
        try {
            String validationErrors = ValidationController.validateAllFields(
                    name, apartmentNumber, email, phone);
            ...
            Customer updatedCustomer = new Customer(id, name, apartmentNumber, email, phone);
