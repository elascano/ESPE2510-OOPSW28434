...
public class FrmContacts extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            ...
            if (saved) {
                JOptionPane.showMessageDialog(rootPane, "Your contact is saved\n" + contact.toString());
            } else {
                JOptionPane.showMessageDialog(rootPane, "Error saving contact", "Error", JOptionPane.ERROR_MESSAGE);
            }
            emptyFields();
