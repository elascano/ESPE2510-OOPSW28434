 ...
 */
public class EcuadorTaxCalculator {
    
    public static double calculateTaxableBase (double grossAnnualIncome, double allowableDeductions){
        //TODO
        double taxBase;
        taxBase = grossAnnualIncome - allowableDeductions;        
        
        return taxBase;
        
    }
    
    public static String findTaxBracket (double taxBase) {
        //TODO
    ...
    public static double calculateTotalTax (double taxBase) {
        //TODO
        double taxableSurplus;
        double taxOnSurplus;
        double totalTax;
