...
public class ContactsBookApp {
    ...
    public static void main(String[] args) {
        ...
        id=1;
        fullName = "Pablo Collaguazo"; 
        phoneNumber = "0959032526";
        type=1;
        email= "pjcollaguazo@espe.edu.ec";
        favorite=true;
        instagramId ="pjcollaguazo";
     ...
     public static void changeContact(Contact contact){
        contact = new Contact(2, "Pablo Collaguazo", "0959032623", 3, "pjcollaguazo@espe.edu.ec", false, "are");
