...
public class Herencia {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            Empleado empleadoTemp = new Empleado(nombre, cedula,salarioBase);
        
            empleadoTemp.validarSalario(salarioBase);
            ...
            if(tipo == 1){
                ...
                System.out.println("Opcion no valida. Debe ser 1, 2 o 3");
            }
            ...
            System.out.println("Salario Base: ");
            registro.actualizarSalario(empleadoTemp,sc.nextDouble());
