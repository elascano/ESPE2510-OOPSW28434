 ...
 */
  public class Contact {
    ...
    private int type; //1= family, 2= friend, 3=job mate, 4= class mate
    ...
    public String toString() {
        ...
        if(this.type ==1)type="job mate";
        if(this.type ==1)type="classmate";
        
        if(this.favorite==true) favorite = "YES, you are";
        else
            favorite="NO, Sorry";
        
        return "Contact-->" + "id=" + id + "," + fullName + "," + phoneNumber + "," + type + "," + email + "," + favorite + "," + instagramId ;
    }
